        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-red-600 mt-1">
              Please contact Norbake Broome to arrange payment. Ph: 04 9726 8803
            </p>
          </div>
        </div>
      )}
  ...
  <div className="text-center py-12">
    ...
    >
      ...
      <p className="mt-6 text-sm text-gray-500">
        To add, change or pause standing orders please contact Norbake Broome directly.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="mt-6 text-sm text-gray-500">
          To update your account details please contact Norbake Broome directly.
        </p>
      </div>
