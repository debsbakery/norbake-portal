...
const PORTAL_URL = 'https://orders.norbakebroome.com/portal'
const APPLY_URL  = 'https://orders.norbakebroome.com/register'
...
export default function PortalQRPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      {/* ── SECTION 2 — New Customer Onboarding Cards ── */}
  ...
  return (
    ...
    >
      <div className="px-6 py-5 text-white text-center" style={{ backgroundColor: '#2c2c2c' }}>
        ...
        <h2 className="text-2xl font-bold tracking-tight">Norbake</h2>
        <p className="text-xs opacity-75 mt-1">Broome WA</p>
      </div>
      ...
      <div className="px-6 py-5 flex flex-col items-center gap-4">
        ...
        <div className="w-full text-center">
          ...
          <p className="text-xs font-mono font-bold" style={{ color: '#8B0000' }}>
            orders.norbakebroome.com/portal
          </p>
        </div>
      ...
      <div className="px-6 py-3 text-center" style={{ backgroundColor: '#f8f4f0' }}>
        <p className="text-xs text-gray-500">
          Questions? Call{' '}
          <span className="font-semibold text-gray-700">0497 268 803</span>
        </p>
      </div>
    </div>
  )
    ...
    >
      ...
      <div className="px-6 py-5 flex flex-col items-center gap-4">
        ...
        <div className="w-full text-center">
          <p className="text-xs text-gray-400 mb-0.5">Or visit</p>
          <p className="text-xs font-mono font-bold" style={{ color: '#8B0000' }}>
            orders.norbakebroome.com/register
          </p>
        </div>
