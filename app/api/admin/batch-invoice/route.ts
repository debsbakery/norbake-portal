                ...
                <div style="padding: 30px; background: #f9f9f9;">
                  ...
                  <div style="text-align: center; margin: 30px 0;">
                    <a href="${siteUrl}/api/invoice/${order.id}" 
                       target="_blank" 
                       rel="noopener"
                       style="display: inline-block; background: #006A4E; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; margin: 5px;">
                      👁️ View Invoice
                    </a>
                    <br>
                    <a href="${siteUrl}/api/invoice/${order.id}?download=true" 
                       download="invoice-${invoiceNumber}.pdf"
                       style="display: inline-block; background: #CE1126; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; margin: 5px;">
                      📥 Download PDF
                    </a>
                    <br>
