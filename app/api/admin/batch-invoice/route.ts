...
function getDebsConfig(): BakeryConfig {
  return {
    name:        process.env.BAKERY_NAME         ?? "Norbake Broome",
    email:       process.env.BAKERY_EMAIL        ?? 'orders@norbakebroome.com',
...
const { data: orders, error: ordersError } = await ordersQuery
    ...
    const emailErrors: string[] = []
      ...
      const invoiceUrl = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://orders.norbakebroome.com'
